...
import "./header.css"
const Header = () => {
    //--------- Change Bacgroung Header
    window.addEventListener("scroll", function () {
        const header = document.querySelector(".header")
        //scroll when is higher than 80, scroll-header
                    ...
                    <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
                        <ul className="nav__list grid">
                            ...
                            <li className="nav__item">
                                ...
                                "nav__link activee-link" : "activee-link"}>
                                    <i className="uil uil-scenery nav__icon"></i> Portforio
                                </a>
                            </li>

                            <li className="nav__item">
                                <a href="#contact" onClick={() => setActiveNav('#portfolio')} className={activeNav === '#portfolio' ? 
                                "nav__link activee-link" : "activee-link"}>
                        ...
                        <i className="nil uil-times nav__close" onClick={() => showMenu (!Toggle)}></i>
